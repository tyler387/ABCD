			...
			<div id="eventTable">
				<table>
					...
					<tbody>
						...
						<tr>
							<td>${el.ADMIN_BOARDNO}</td>
							<td><a href="./detail?adminBoardno=${el.ADMIN_BOARDNO}&curPage=${paging.curPage}">${el.TITLE}</a></td>
							<td>${el.USER_NICK}</td>
							<td><fmt:formatDate value="${el.WRITE_DATE}" pattern="yyyy.MM.dd HH:mm"/></td>
						</tr>
						</c:forEach>
					</tbody>
				</table>
