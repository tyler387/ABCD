...
<div class="d-flex justify-content-between" style ="width: 400px; margin: 0 auto;">
		<div class="border">
	<a href="<%=request.getContextPath() %>/admin/report/user/state?ruserno=${report.R_USERNO }&type=approval&reportno=${report.REPORTNO }"><button id="approval_btn"  class="btn btn-secondary">승인</button></a>
		</div>
		<div class="border">
	<a href="<%=request.getContextPath() %>/admin/report/user/state?reportno=${report.REPORTNO }&type=cancel"><button id="cancel_btn"  class="btn btn-secondary">반려</button></a>
		</div>
		<div class="border">
