			...
			<form action="./write" method="post">
				...
				<table>
					...
					<tr>
						...
						<th><input type="text" id="qTitle" name="qTitle" style="width:500px; height:30px;"></th>
					</tr>
					<tr>
						<th><label for="qContent">문의내용</label></th>
						<th><textarea id="qContent" name="qContent" style="width:500px; height:500px;resize: none"></textarea></th>
					</tr>
				</table>
				<div>
					<button>문의등록</button>
