...
<c:if test="${paging.startPage ne 1}">
	<li><a href="./allFile?curPage=${paging.startPage-paging.pageCount}">&laquo;</a></li>
</c:if>
...
<c:if test="${paging.curPage gt 1}">
	<li><a href="./allFile?curPage=${paging.curPage-1}">&lt;</a></li>
</c:if>
...
<c:forEach var="i" begin="${paging.startPage}" end="${paging.endPage}">
	<li><a href="./allFile?curPage=${i}">${i}</a></li>	
</c:forEach>
<%--====================================================================--%>
...
<c:if test="${paging.endPage ne paging.totalPage}">
	<li><a href="./allFile?curPage=${paging.startPage+paging.pageCount}">&raquo;</a></li>
</c:if>
...
<c:if test="${paging.curPage ne paging.totalPage}">
	<li><a href="./allFile?curPage=${paging.totalPage}">끝 페이지</a></li>
</c:if>
