...
public class MeetingPaging {
	...
	public MeetingPaging() {}

	public MeetingPaging(int curPage, int totalCount) {
		setCurPage(curPage);
		setTotalCount(totalCount);
		makePaging();
	}

	public MeetingPaging(int curPage, int totalCount, int listCount, int pageCount) {
		setCurPage(curPage);
		setTotalCount(totalCount);
