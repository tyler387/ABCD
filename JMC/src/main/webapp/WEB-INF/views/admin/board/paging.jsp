...
<c:if test="${paging.curPage ne 1}">
	<li><a href="./list?boardOption=${boardOption}">첫 페이지</a></li>
</c:if>
...
<c:if test="${paging.startPage ne 1}">
	<li><a href="./list?curPage=${paging.startPage-paging.pageCount}&boardOption=${boardOption}">&laquo;</a></li>
</c:if>
...
<c:if test="${paging.curPage gt 1}">
	<li><a href="./list?curPage=${paging.curPage-1}&boardOption=${boardOption}">&lt;</a></li>
</c:if>
...
<c:forEach var="i" begin="${paging.startPage}" end="${paging.endPage}">
	<li><a href="./list?curPage=${i}&boardOption=${boardOption}">${i}</a></li>	
</c:forEach>
<%--====================================================================--%>
...
<c:if test="${paging.endPage ne paging.totalPage}">
	<li><a href="./list?curPage=${paging.startPage+paging.pageCount}&boardOption=${boardOption}">&raquo;</a></li>
</c:if>
...
<c:if test="${paging.curPage ne paging.totalPage}">
	<li><a href="./list?curPage=${paging.totalPage}&boardOption=${boardOption}">끝 페이지</a></li>
</c:if>
